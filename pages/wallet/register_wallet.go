...
func (p *RegisterWalletForm) Layout(gtx layout.Context, th *material.Theme) layout.Dimensions {
	...
	widgets = append(widgets, func(gtx layout.Context) layout.Dimensions {
		lbl := material.Label(th, unit.Sp(14), lang.Translate("The Dero blockchain is an account based model and requires a one-time POW registration process to avoid spam."))
